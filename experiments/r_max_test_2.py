...
env = gym.make("ALE/" + game_name , frameskip = 2  ,render_mode="rgb_array")
...
state_space_size = 4000 # Number of states in the state space
...
for episode in range(1000):
    ...
    if episode % 5 == 0:
        ...
        plt.legend()
        plt.savefig('reward_per_episode_VQ_matrix4.png')
        plt.close()
